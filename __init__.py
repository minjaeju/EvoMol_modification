...
from .evaluation import EvaluationStrategy, GenericFunctionEvaluationStrategy, QEDEvaluationStrategy, BAEvaluationStrategy, MJnetEvaluationStrategy,\
...
def _is_describing_implemented_function(param_eval):
    ...
    return param_eval in ["BA", "mjnet", "qed", "sascore", "norm_sascore", "plogp", "norm_plogp", "clscore", "homo", "lumo",
...
def _build_evaluation_strategy_from_implemented_function(param_eval, explicit_IO_parameters_dict,
    ...
    if param_eval == "qed":
        ...
        strat = BAEvaluationStrategy()
    elif param_eval == "mjnet":
        strat = MJnetEvaluationStrategy()
